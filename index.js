...
const { RNReactNativeShareIosWx } = NativeModules;

const emitter = new EventEmitter();

DeviceEventEmitter.addListener('RNReactNativeShareIosWx_Resp', resp => {
 ...
 * @return {Promise}
 */
export const registerApp = wrapRegisterApp(RNReactNativeShareIosWx.registerApp);

/**
 * Return if the RNReactNativeShareIosWx app is installed in the device.
 * @method isWXAppInstalled
 * @return {Promise}
 */
export const isWXAppInstalled = wrapApi(RNReactNativeShareIosWx.isWXAppInstalled);

/**
 * Return if the RNReactNativeShareIosWx application supports the api
 * @method isWXAppSupportApi
 * @return {Promise}
 */
export const isWXAppSupportApi = wrapApi(RNReactNativeShareIosWx.isWXAppSupportApi);

/**
 * Get the RNReactNativeShareIosWx app installed url
 * @method getWXAppInstallUrl
 * @return {String} the RNReactNativeShareIosWx app installed url
 */
export const getWXAppInstallUrl = wrapApi(RNReactNativeShareIosWx.getWXAppInstallUrl);

/**
 * Get the RNReactNativeShareIosWx api version
 * @method getApiVersion
 * @return {String} the api version string
 */
export const getApiVersion = wrapApi(RNReactNativeShareIosWx.getApiVersion);

/**
 * Open RNReactNativeShareIosWx app
 * @method openWXApp
 * @return {Promise}
 */
export const openWXApp = wrapApi(RNReactNativeShareIosWx.openWXApp);

// wrap the APIs
const nativeShareToTimeline = wrapApi(RNReactNativeShareIosWx.shareToTimeline);
const nativeShareToSession = wrapApi(RNReactNativeShareIosWx.shareToSession);
const nativeShareToFavorite = wrapApi(RNReactNativeShareIosWx.shareToFavorite);
const nativeSendAuthRequest = wrapApi(RNReactNativeShareIosWx.sendAuthRequest);
...
export function sendAuthRequest(scopes, state) {
  return new Promise((resolve, reject) => {
    RNReactNativeShareIosWx.sendAuthRequest(scopes, state, () => {});
